...
namespace OutSysCollegeManagement.Migrations
{
    ...
    [Migration("20241110085749_AddFacultyForeignKeyToFaculty_Phone_v1")]
    partial class AddFacultyForeignKeyToFaculty_Phone_v1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OutSysCollegeManagement.Models.Faculty_Phone", b =>
                {
                    ...
                    b.HasKey("SID", "Mobile_no", "Fid");

                    b.HasIndex("Fid");

                    b.ToTable("Faculty_Phones");
                });
